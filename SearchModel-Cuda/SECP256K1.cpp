...
(buff)[8] = 0x00800000 | ((uint32_t)(((unsigned char*)&p.x.bits[0])[3]) << 24); /* <--- FIXED [0] to [3] */ \
(buff)[9] = 0; \
(buff)[10] = 0; \
(buff)[11] = 0; \
(buff)[12] = 0; \
...
(buff)[6] = ((p).x.bits[1] >> 8) | ((p).x.bits[2] <<24); \
(buff)[7] = ((p).x.bits[0] >> 8) | ((p).x.bits[1] <<24); \
(buff)[8] = ((p).y.bits[7] >> 8) | ((uint32_t)(((unsigned char*)&p.x.bits[0])[3]) << 24); /* <--- FIXED [0] to [3] */ \
...
(buff)[16] = 0x00800000 | ((uint32_t)(((unsigned char*)&p.y.bits[0])[3]) << 24); /* <--- FIXED [0] to [3] */ \
(buff)[17] = 0; \
(buff)[18] = 0; \
(buff)[19] = 0; \
(buff)[20] = 0; \
